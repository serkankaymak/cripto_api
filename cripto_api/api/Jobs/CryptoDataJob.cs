...
public class CryptoDataJob
{
    ...
    private readonly ILogger<CryptoDataJob> _logger;

    public CryptoDataJob(ICryptoDataService cryptoDataService, ILogger<CryptoDataJob> logger, IEventDispatcher eventDispatcher)
    {
